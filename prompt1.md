# Prompt
```
  Here is a Work Sample Request Problem for a company that I really want to work at:
  ...
  How would you approach problem one? Given the rest of the scope of work? 
```
